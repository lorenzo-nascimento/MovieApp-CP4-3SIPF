...
import 'package:movie_app/pages/favorite_page.dart'; // Importe a página de favoritos
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              // Adiciona todos os filmes que são favoritos
              popular.then((data) {
                favoriteMovies.addAll(data.movies.where((movie) => movie.isFavorite));
              });
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => FavoriteMoviesPage(favoriteMovies: favoriteMovies),
                ),
              );
            },
          ),
